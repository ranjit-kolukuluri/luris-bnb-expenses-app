...
export const SEED_TRANSACTIONS: Transaction[] = [
  ...
  tx({
    ...
    description:
      "Based on Zelle to Is A Realtor — June 2026 property management $702.50 (paid 07/04).",
    amount: 702.5,
  ...
  // —— July 2026 BoA Zelle (live — July statement not issued) ——
  // Ignored personal: Ravi Tempalli $25, Achut $660 Vegas
  tx({
    id: "tx-mgmt-june-paid-jul",
    unit_id: null,
    category_id: "cat-mgmt",
    type: "expense",
    cadence: "one_time",
    expense_group: "property_management",
    expense_subgroup: "monthly_mgmt",
    title: "Property management — June 2026",
    description:
      "Zelle to Is A Realtor 07/04 — “June 2026 - property management charges”. Applied to June.",
    amount: 702.5,
  ...
  tx({
    ...
    cadence: "one_time",
    title: "Weed cleanup",
    description: "Zelle to Is A Realtor 07/11 — weed cleanup (ops).",
    amount: 50,
  ...
  tx({
    id: "tx-contractor-1r-jul-electrical",
    unit_id: "unit-1r",
    category_id: "cat-reno",
    type: "expense",
    cadence: "one_time",
    expense_group: "contractor_fees",
    expense_subgroup: "labor",
    title: "1R reno — electrical & plumbing (Israel)",
    description:
      "Zelle to Is A Realtor 07/17 — “1R - Renovation -Electrical and Plumbing - WO 071726”.",
    amount: 3250,
  ...
  tx({
    ...
    expense_group: "contractor_fees",
    expense_subgroup: "labor",
    title: "1R reno — contractor fees (Israel managed)",
    description:
      "Zelle to Is A Realtor 07/24 $3,500 — contractor fees Israel is managing for 1R reno.",
    amount: 3500,
  ...
  tx({
    ...
    title: "1R reno — contractor fees (Israel managed)",
    description:
      "Zelle to Is A Realtor 07/25 $100 — “1R - Renovation”; contractor fees Israel is managing.",
    amount: 100,
  ...
  tx({
    ...
    title: "1L rent — Ariel Y Blanca (Zelle)",
    description:
      "July rent via Zelle to BoA — $2,900 (received 07/02 from ARIEL Y BLANCA).",
    amount: 2900,
